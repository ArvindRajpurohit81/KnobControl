...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Arvind Purohit" => "arvind.purohit@wwindia.com" }
  # Or just: spec.author    = "Arvind Purohit"
  # spec.authors            = { "Arvind Purohit" => "arvind.purohit@wwindia.com" }
  # spec.social_media_url   = "https://twitter.com/Arvind Purohit"
  ...
  #
  	...
  	s.source       = { :git => "https://github.com/arvind8192/KnobControl.git", :tag => "1.0.0" }
